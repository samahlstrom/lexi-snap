...
3. **Highlight word with context** - Select the word AND its surrounding sentence
   - Example: Highlight `"The serendipitous discovery changed everything"`
   - The program will look up only the first word but save the full sentence as context
...
1. Highlight the **word and sentence**: `"The serendipitous discovery changed everything"`
2. Press **Ctrl+Alt+D** (Windows) or use Services menu (macOS)
3. Select "English Vocabulary" deck
4. Card created! ✓

**Note:** The program automatically extracts "serendipitous" for the dictionary lookup while keeping your full selection as context.
