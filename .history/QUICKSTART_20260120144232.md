...
3. Highlight a word WITH context (try: `"ubiquitous smartphone has transformed modern communication"`)
4. Press **Ctrl+Alt+D** (Windows) or Services → "Send to Anki" (macOS)
5. Choose a deck
6. Check Anki to see your new card!

**Tip:** Always highlight the word AND its sentence. The program extracts just the first word for lookup but saves the full sentence as context.
